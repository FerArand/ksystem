...
class AppDatabase {
  ...
  Future onUpgrade(Database db, int oldVersion, int newVersion) async {
    ...
    // Nueva migración para la versión 7
    if (oldVersion < 7) {
      await FacturerosDB.createTable(db);
    }
  }
  ...
  Future _createDB(Database db, int version) async {
    ...
    // Tabla inicializada para instalaciones nuevas
    await FacturerosDB.createTable(db);
  }
}